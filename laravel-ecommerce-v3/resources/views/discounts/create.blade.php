    ...
    <div class="container mt-5">
        <div class="card border-0 shadow-sm rounded-4 px-4 py-3" style="background-color: #4ED7F1;">
            <div class="card-header border-0 bg-white px-0 pb-0">
                ...
                <p class="text-muted">Fill out the form below to add a new discount.</p>
            </div>
                ...
                <form action="{{ route('discounts.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="discount_name" class="form-control form-control-lg rounded-3" value="{{ old('discount_name') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="discount_percent" class="form-control form-control-lg rounded-3" value="{{ old('discount_percent') }}" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="discount_description" class="form-control form-control-lg rounded-3" rows="4">{{ old('discount_description') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="active" class="form-select form-select-lg rounded-3" required>
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-dark btn-lg px-4 rounded-3">Create Discount</button>
                        </div>
                    </div>
                </form>
            </div>
