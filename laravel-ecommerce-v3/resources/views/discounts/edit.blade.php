            ...
            <form action="{{ route('discounts.update', $discount['id']) }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="discount_name" class="form-control form-control-lg rounded-3"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="discount_percent" class="form-control form-control-lg rounded-3"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="discount_description" class="form-control form-control-lg rounded-3" rows="4">{{ old('discount_description', $discount['discount_description']) }}</textarea>
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-dark btn-lg px-4 rounded-3">Update Discount</button>
                    </div>
                </div>
            </form>
        </div>
