...
function Edit() {
    const { flash, enrollment, availableTenants, availableStudents, availableCourses, isNormalAdmin } = usePage<PageProps>().props;
    const { data, setData, put, processing, errors } = useForm({
        tenant_id: enrollment.tenant_id.toString(),
        student_id: enrollment.student_id.toString(),
        course_id: enrollment.course_id.toString(),
        fee: enrollment.fee.toString(),
    });
