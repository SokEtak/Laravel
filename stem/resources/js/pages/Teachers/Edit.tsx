...
function Edit() {
    const { flash, teacher, availableTenants, availableSubjects, isNormalAdmin } = usePage<PageProps>().props;
    const { data, setData, put, processing, errors } = useForm({
        tenant_id: teacher.tenant_id.toString(),
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Teacher: ${teacher.first_name} ${teacher.last_name}`} />
