<x-layout title="Create New Inventory">
        ...
        <div class="card shadow rounded-4 border-0 p-4 bg-dark text-white">
            <form action="{{ route('inventories.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control bg-secondary text-white border-0 @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity') }}" required min="0">
                    @error('quantity')
